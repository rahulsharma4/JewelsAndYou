    ...
    <div className="min-h-[70vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold font-heading text-brand-dark">Create Account</h1>
          <p className="text-brand-dark/60 text-sm">Join us for an exclusive experience</p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <div>
            <label className="block text-[10px] font-bold uppercase tracking-wider text-brand-dark/60 mb-1.5 ml-1">Password</label>
